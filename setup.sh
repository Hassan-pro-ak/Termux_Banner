...
cd $HOME/Termux_Banner
cp login.sh $PREFIX/etc
chmod +x login.sh delete.sh setup.sh sound_effect.py banner.sh update.sh
mkdir -p $HOME/TermuX-Custom/Song 
mv Access-Granted.mp3 Jarvis2.mp3 JARVIS.mp3 sound_effect.py $HOME/Termux_Banner/Song
rm 1
mkdir -p $HOME/Termux_Banner/NETWORK
mv network.py $HOME/Termux_Banner/NETWORK
